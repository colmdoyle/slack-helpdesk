import { StaticSelect, MrkdwnElement, Overflow, ImageElement, Select, MultiSelect, Datepicker, ContextBlock, SectionBlock, Option, DividerBlock, Action, ActionsBlock, Button, InputBlock, PlainTextInput, ExternalSelect } from '@slack/types'
...
export function inputSelectStatic(title:string, placeholder: string, options: Option[], actionID: string) : InputBlock {
    const staticSelect: StaticSelect = {
        // eslint-disable-next-line @typescript-eslint/camelcase
        type: 'static_select',
        // eslint-disable-next-line @typescript-eslint/camelcase
        action_id: actionID,
    ...
    return inputBlock(title, actionID, staticSelect);
}
